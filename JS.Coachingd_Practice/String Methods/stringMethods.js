...
// console.log("Character at index 4:", str.charAt(3)); //
// 2. charCodeAt(): Get Unicode of character at index
// console.log("Unicode of character ", str.charAt(4) + " : " + str.charCodeAt(4)); //
...
// console.log("Last Index of 'is':", str.lastIndexOf("JavaScript")); //
...
console.log("Search for 'JavaScript':", str2.search("JavaScript"));
