...
const str4 = "kiran kumar";
// console.log(str.length); //

// 1. charAt(): Get character at a specific index
// console.log("Character at index 4:", str4.charAt(2)); // r

// // 2. charCodeAt(): Get Unicode of character at index
// console.log("Unicode of character at index 4:", str4.charCodeAt(4)); //
...
// console.log("Last Index of 'is':", str.lastIndexOf(" ")); //
...
// console.log("Search for 'JavaScript':", str.search("JavaScript")); //
...
// console.log("Starts with 'Java':", str.startsWith(" ")); //
